...
class Cidadao(Base):
    ...
    nome_social: Mapped[str | None] = mapped_column(String(150))
...
class Alergia(Base):
    ...
    substancia: Mapped[str] = mapped_column(String(150))
    ...
    reacao: Mapped[str | None] = mapped_column(String(255))
    ativo: Mapped[bool] = mapped_column(Boolean, default=True)
...
class MedicamentoEmUso(Base):
    ...
    id: Mapped[uuid.UUID] = _pk()
    cidadao_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("cidadaos.id", ondelete="CASCADE"))
    descricao: Mapped[str] = mapped_column(String(200))  # "Losartana 50 mg"
    posologia: Mapped[str | None] = mapped_column(String(200))  # "1 comprimido de manhã"
    via: Mapped[str | None] = mapped_column(String(30))
...
class ProblemaAtendimento(Base):
    ...
    sistema: Mapped[str] = mapped_column(String(6))  # CID10 | CIAP2
...
class Prescricao(Base):
    ...
    posologia: Mapped[str] = mapped_column(String(255))
    quantidade: Mapped[str | None] = mapped_column(String(60))
    via: Mapped[str | None] = mapped_column(String(30))
...
class SolicitacaoExame(Base):
    ...
    indicacao_clinica: Mapped[str | None] = mapped_column(String(255))
...
class CatalogoMedicamento(Base):
    ...
    apresentacao: Mapped[str | None] = mapped_column(String(120))
